...
// 	void Configure(GPUSurfaceConfiguration surfaceConfiguration);
// 	void Present();
// 	public WGPURequestAdapterOptions RequestAdapterOptions { get; }
// 	uint DepthSliceUndefined { get; }
// }

public unsafe class GPUSurface(WGPUSurface handle, string? label, bool Emscripten) : GPUObjectWithName<WGPUSurface>(handle, label)
{
