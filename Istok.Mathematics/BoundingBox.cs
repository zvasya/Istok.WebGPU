...
public struct BoundingBox(Vector3 center, Vector3 extent) : IEquatable<BoundingBox>
{
    ...
    public bool Intersect(ref readonly BoundingBox other)
    {
        return Vector128.LessThanOrEqualAll(Minimum.AsVector128(), other.Minimum.AsVector128())
               && Vector128.GreaterThanOrEqualAll(Maximum.AsVector128(), other.Maximum.AsVector128());
    }

    public bool Contains(ref readonly BoundingBox other)
    {
        return Vector128.LessThanOrEqualAll(Minimum.AsVector128(), other.Maximum.AsVector128())
               && Vector128.GreaterThanOrEqualAll(Maximum.AsVector128(), other.Minimum.AsVector128());
    }
